const apiKey = '3ea3ae0c0793f3194642ad4fb511e1d5'; // Reemplaza con tu clave API
...
async function fetchPopularMovies() {
    try {
        const response = await fetch(`${apiUrl}/movie/popular?api_key=${apiKey}&language=en-US&page=1`); //Realiza una solicitud GET a la API
        const data = await response.json(); //Convierte la respuesta a JSON
        displayMovies(data.results); //Llama a la funcion displayMovies para mostrar las peliculas
    } catch (error) {
